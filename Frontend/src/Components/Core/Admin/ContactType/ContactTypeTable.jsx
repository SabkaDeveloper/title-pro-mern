...
const ContactTypeList = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-4 bg-white text-black min-h-screen w-[1300px] shadow-lg shadow-gray-900 ">
    ...
    <div className="mb-4 shadow-md shadow-gray-500">
      <input
        ...
        className="w-full p-2 border rounded border-gray-500 shadow-sm shadow-gray-700"
        value={search}
