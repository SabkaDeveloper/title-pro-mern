...
const ContactList = () => {
  ...
  return (
    <Container fluid > 
      <h4 className="mt-1" style={{transform:'translateX(-105px)'}}>Contact List</h4>
      {/* Tabs */}
      <ul className="nav nav-tabs" style={{transform:'translateX(-120px)' , width: '119%'}}>
      ...
      {/* Search & Filters */}
      <Row className="d-flex justify-content-end my-1 g-2 mb-2" style={{marginRight: "-128px"}}>
      <Col xs={12} sm={6} md={3}>
      ...
      {/* Contacts Table */}
    <div className="table-responsive w-200" style={{ width: "1516px", transform : 'translate(-120px)' }}>
      ...
      <Pagination className="justify-content-center flex-wrap">
        ...
        {[...Array(totalPages).keys()].slice(0, 5).map((page) => (
          <Pagination.Item
           key={page} active={page + 1 === activePage} onClick={() => handlePageChange(page + 1)}>
            {page + 1}
          </Pagination.Item>
        ))}
